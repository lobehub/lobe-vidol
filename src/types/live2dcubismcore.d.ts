...
declare namespace Live2DCubismCore {
  ...
  const Utils = {
     ...
     */
    hasBlendAdditiveBit(bitfield: number): boolean;,
    /**
     * Checks whether flag is set in bitfield.
     *
     * @param bitfield Bitfield to query against.
     ...
     * @return [[true]] if bit set; [[false]] otherwise
     */
    hasBlendMultiplicativeBit(bitfield: number): boolean;,
    /**
     * Checks whether flag is set in bitfield.
     *
     * @param bitfield Bitfield to query against.
     ...
     * @return [[true]] if bit set; [[false]] otherwise
     */
    hasIsDoubleSidedBit(bitfield: number): boolean;,
    /**
     * Checks whether flag is set in bitfield.
     *
     * @param bitfield Bitfield to query against.
     ...
     * @return [[true]] if bit set; [[false]] otherwise
     */
    hasIsInvertedMaskBit(bitfield: number): boolean;,
    /**
     * Checks whether flag is set in bitfield.
     *
     * @param bitfield Bitfield to query against.
     ...
     * @return [[true]] if bit set; [[false]] otherwise
     */
    hasIsVisibleBit(bitfield: number): boolean;,
    /**
     * Checks whether flag is set in bitfield.
     *
     * @param bitfield Bitfield to query against.
     ...
     * @return [[true]] if bit set; [[false]] otherwise
     */
    hasVisibilityDidChangeBit(bitfield: number): boolean;,
    /**
     * Checks whether flag is set in bitfield.
     *
     * @param bitfield Bitfield to query against.
     ...
     * @return [[true]] if bit set; [[false]] otherwise
     */
    hasOpacityDidChangeBit(bitfield: number): boolean;,
    /**
     * Checks whether flag is set in bitfield.
     *
     * @param bitfield Bitfield to query against.
     ...
     * @return [[true]] if bit set; [[false]] otherwise
     */
    hasDrawOrderDidChangeBit(bitfield: number): boolean;,
    /**
     * Checks whether flag is set in bitfield.
     *
     * @param bitfield Bitfield to query against.
     ...
     * @return [[true]] if bit set; [[false]] otherwise
     */
    hasRenderOrderDidChangeBit(bitfield: number): boolean;,
    /**
     * Checks whether flag is set in bitfield.
     *
     * @param bitfield Bitfield to query against.
     ...
     * @return [[true]] if bit set; [[false]] otherwise
     */
    hasVertexPositionsDidChangeBit(bitfield: number): boolean;,
    /**
     * Checks whether flag is set in bitfield.
     *
     * @param bitfield Bitfield to query against.
     ...
     * @return [[true]] if bit set; [[false]] otherwise
     */
    hasBlendColorDidChangeBit(bitfield: number): boolean;,
  };
  /** Memory functions. */
  class Memory {
    /**
